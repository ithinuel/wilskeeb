...
pub static LAYERS: keyberon::layout::Layers<14, 5, 4, CustomAction> = [
    [
        ...
        [k(Tab),    k(Q),       k(W),   k(E),    k(R),      k(T),     NoOp,      k(Equal),  k(Y),      k(U),      k(I),     k(O),        k(P),        k(RBracket)],
        ...
        [k(Pause),  k(PScreen), NoOp,   k(LAlt), k(Escape), k(Enter), k(Space),  k(BSpace), l(1),      k(RAlt),   k(LGui),  k(Minus),    NoOp,        k(ScrollLock)],
    ], [
